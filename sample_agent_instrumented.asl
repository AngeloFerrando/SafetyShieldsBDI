events([// Agent sample_agent in project k3
...
+!inspect_nuclear_plant : fast & .intention(I, _, Stack, current) & (ids(I, IDs) | IDs=[]) & (depth(I, Depth)|Depth=0) & .concat("shield1_id0_", Depth, IntIDD) & not(.member(IntIDD, IDs)) <- -depth(I, _); +depth(I, Depth+1); !push_id(I, "shield1", IntIDD); ?ids(I, CurrentlyActShields); ?events(Events); add_shield(I, "shield1", "G(add_belief(perc_rad(low)))", Events); .term2string(goal(inspect(wp1)), Term0); update_shield(I, CurrentlyActShields, Term0); !inspect(wp1); .term2string(action(move_to(wp2, R2)), Term1); update_shield(I, CurrentlyActShields, Term1); move_to(wp2, R2); .term2string(remove_belief(perc_rad(R2)), Term2); update_shield(I, CurrentlyActShields, Term2); -perc_rad(R2); .term2string(add_belief(perc_rad(R2)), Term3); update_shield(I, CurrentlyActShields, Term3); +perc_rad(R2); !get_count(I, "shield1", Count, 1); !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1").
+!inspect_nuclear_plant : true & .intention(I, _, Stack, current) & (ids(I, IDs) | IDs=[]) & (depth(I, Depth)|Depth=0) & .concat("shield1_id1_", Depth, IntIDD) & not(.member(IntIDD, IDs)) <- -depth(I, _); +depth(I, Depth+1); !push_id(I, "shield1", IntIDD); ?ids(I, CurrentlyActShields); ?events(Events); add_shield(I, "shield1", "G(add_belief(perc_rad(low)))", Events); .term2string(goal(inspect(wp1)), Term0); update_shield(I, CurrentlyActShields, Term0); !inspect(wp1); .term2string(action(move_to(wp4, R4)), Term1); update_shield(I, CurrentlyActShields, Term1); move_to(wp4, R4); .term2string(remove_belief(perc_rad(R4)), Term2); update_shield(I, CurrentlyActShields, Term2); -perc_rad(R4); .term2string(add_belief(perc_rad(R4)), Term3); update_shield(I, CurrentlyActShields, Term3); +perc_rad(R4); !get_count(I, "shield1", Count, 1); !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1").
