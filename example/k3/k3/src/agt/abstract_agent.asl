...
+!plan1 : count(100) & .intention(I, _, Stack, current) & ids(I, IDs) & (depth(I, Depth)) & .concat("shield1_id0_", Depth, IntIDD) & not(.member(IntIDD, IDs)) <- -depth(I, _); +depth(I, Depth+1); !push_id(I, "shield1", IntIDD); ?ids(I, CurrentlyActShields); add_shield(I, "shield1", "G(add_belief(belief4) -> X(action(action3)))"); !get_count(I, "shield1", Count, 1); !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1").
+!plan1 : count(C) & .intention(I, _, Stack, current) & ids(I, IDs) & (depth(I, Depth)) & .concat("shield1_id1_", Depth, IntIDD) & .print(IntIDD,"---", IDs) & not(.member(IntIDD, IDs)) <- -depth(I, _); +depth(I, Depth+1); !push_id(I, "shield1", IntIDD); ?ids(I, CurrentlyActShields); add_shield(I, "shield1", "G(add_belief(belief4) -> X(action(action3)))"); update_shield(I, CurrentlyActShields, "remove_belief(count(_))"); -count(_); update_shield(I, CurrentlyActShields, "add_belief(count(C+1))"); +count(C+1); update_shield(I, CurrentlyActShields, "add_belief(belief4)"); +belief4; update_shield(I, CurrentlyActShields, "action(action4)"); action4; update_shield(I, CurrentlyActShields, "goal(plan1)"); !plan1; !get_count(I, "shield1", Count, 1); !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1").
+!plan1 : .print("blaaa") & .intention(I, _, Stack, current) & ids(I, IDs) & (depth(I, Depth)) & .concat("shield1_id2_", Depth, IntIDD) & .print(IntIDD,"---", IDs) & not(.member(IntIDD, IDs)) <- .print("here"); -depth(I, _); +depth(I, Depth+1); !push_id(I, "shield1", IntIDD); ?ids(I, CurrentlyActShields); add_shield(I, "shield1", "G(add_belief(belief4) -> X(action(action3)))"); update_shield(I, CurrentlyActShields, "action()"); !get_count(I, "shield1", Count, 1); !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1").
-!plan1 : .intention(I, _, Stack, current) & violated(I, "shield1", Cmds) & (count(I, "shield1", Count) | Count = 1) & depth(I, D) & D >= 1 <- .print("retry"); !toTerms(Cmds, TCmds); !restore(TCmds); -depth(I, D); +depth(I, D-1); !plan1.
-!plan1 : .intention(I, _, Stack, current) & (count(I, "shield1", Count) | Count = 1) & depth(I, D) & D >= 1 <- !pop_count(I, Count, ThisShieldId); remove_shield(I, "shield1"); -depth(I, D); +depth(I, D-1); .fail.
